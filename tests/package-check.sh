...
python3 -m py_compile "$ROOT/platform-src/agentdev/execution/isolation.py" "$ROOT/tests/codex-runtime-isolation-regression.py" "$ROOT/tests/cursor-credential-confidentiality-regression.py" "$ROOT/tests/e2e/cursor-credential-confidentiality-probe.py"
