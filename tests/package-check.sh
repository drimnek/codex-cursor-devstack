...
python3 -m py_compile "$ROOT/tests/cursor-task-egress-regression.py"
...
python3 "$ROOT/tests/cursor-task-egress-regression.py"
...
python3 "$ROOT/tests/task-egress-contract-regression.py"
...
python3 "$ROOT/tests/cursor-runtime-isolation-regression.py"
