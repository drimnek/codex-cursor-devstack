...
python3 -m py_compile "$ROOT/platform-src/agentdev/policy/resolver.py" "$ROOT/platform-src/agentdev/policy/profiles.py" "$ROOT/tests/policy-resolver-regression.py" "$ROOT/tests/execution-profiles-regression.py"
