...
python3 -m py_compile "$ROOT/platform-src/bin/agentctl" "$ROOT/platform-src/bin/agentd" "$ROOT/platform-src/agentdev/broker/cli.py" "$ROOT/platform-src/agentdev/broker/daemon.py" "$ROOT/platform-src/agentdev/broker/rpc.py" "$ROOT/platform-src/agentdev/agents/base.py" "$ROOT/platform-src/agentdev/agents/registry.py" "$ROOT/platform-src/agentdev/core/models.py" "$ROOT/platform-src/agentdev/core/validation.py" "$ROOT/platform-src/agentdev/core/projects.py" "$ROOT/platform-src/agentdev/core/git_handoff.py" "$ROOT/platform-src/agentdev/core/tasks.py" "$ROOT/platform-src/agentdev/core/dependencies.py" "$ROOT/platform-src/agentdev/core/worktrees.py" "$ROOT/platform-src/agentdev/core/locking.py" "$ROOT/tests/security-regression.py" "$ROOT/tests/cursor-policy-reconciliation-regression.py"
